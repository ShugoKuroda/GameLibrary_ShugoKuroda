...
//	マクロ定義
//======================================================
#define MAX_SCORE		(8)			//最大スコア数
#define SCORE_SIZE_X	(20.0f)		//スコア表記のサイズ(x)
#define SCORE_SIZE_Y	(40.0f)		//スコア表記のサイズ(y)
...
void InitScore(void)
{
	...
	g_posScore = D3DXVECTOR3((SCREEN_WIDTH / 2.0f) - 10.0f, 0.0f, 0.0f);		//位置の初期化
	g_nScore = 0;			//値の初期化
	g_nAddScore = 0;
